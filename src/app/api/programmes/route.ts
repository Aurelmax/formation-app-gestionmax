      ...
      return NextResponse.json(
        ...
        { status: 400 }
          ...
          const newProgramme = {
            ...
            prerequis: body.prerequis || 'Maîtriser son environnement et les fonctions de base pour utiliser un ordinateur.',
            publicConcerne: body.publicConcerne || 'Artisans, commerçants, professions libérales et entrepreneurs.',
            ...
            ressources: body.ressources || ['Salle de formation équipée', 'Support de cours', 'Matériel informatique'],
            modalitesEvaluation: body.modalitesEvaluation || 'Évaluation des connaissances théoriques et travaux pratiques',
            ...
            accessibiliteHandicap: body.accessibiliteHandicap || 'Entretien téléphonique pour évaluer les besoins spécifiques au regard d\'une situation de handicap, mise en œuvre des adaptations pédagogiques, organisationnelles et matérielles nécessaires.',
            cessationAbandon: body.cessationAbandon || 'En cas de renonciation avant le début de la formation, aucune facturation. En cas de renonciation en cours de formation, la facturation se fera au prorata de l\'assiduité.',
            ...
            formateurBiographie: body.formateurBiographie || 'Aurélien LAVAYSSIERE est un consultant formateur en informatique de gestion, spécialisé dans la formation des adultes. Doté d\'une solide expérience dans le domaine de la formation, Aurélien possède une expertise approfondie en matière de technologies web et de gestion d\'entreprise.',
            createdAt: new Date(),
            updatedAt: new Date()
          };
