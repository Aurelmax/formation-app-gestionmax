      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Gestion des programmes de formation personnalisés créés après entretien de positionnement
          </p>
        </div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {programmes.map((programme) => (
          <Card key={programme._id} className="hover:shadow-lg transition-shadow">
            <CardHeader>
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">{programme.modalites_acces.duree}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground">Tarif:</span>
                  <span className="font-medium">{programme.modalites_acces.tarif}€</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground">Formateur:</span>
                  <span className="font-medium">{programme.contact_formateur.nom}</span>
                </div>
                <div className="pt-3 border-t">
                  <p className="text-xs text-muted-foreground line-clamp-2">
                    {programme.modalites_acces.public_concerne}
                  </p>
                </div>
                <div className="grid grid-cols-2 gap-2 pt-3">
                  <Button variant="outline" size="sm" asChild>
                    <Link href={`/admin/formation-programmes/${programme._id}`}>
                      <Eye className="h-4 w-4 mr-1" />
                      Voir
                    </Link>
                  </Button>
                  <Button variant="outline" size="sm" asChild>
                    <Link href={`/admin/formation-programmes/${programme._id}/edit`}>
                  ...
                  <Button 
                    ...
                    onClick={() => handleDelete(programme._id, programme.title)}
                  >
                  ...
                  <Button 
                    ...
                    onClick={() => handleDownloadPDF(programme._id, programme.title)}
                  >
