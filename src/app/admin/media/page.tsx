    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Glissez-déposez vos fichiers ici ou cliquez pour sélectionner</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-gray-400 transition-colors">
            ...
            <p className="text-gray-600 mb-4">
              Formats supportés: JPG, PNG, GIF, PDF, DOC, DOCX
            </p>
            <Button>
              <Upload className="h-4 w-4 mr-2" />
                ...
                <Card key={media.id} className="hover:shadow-lg transition-shadow">
                  <CardHeader className="pb-2">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge className={getTypeBadgeColor(media.type)}>
                        {media.type}
                      </Badge>
                    </div>
                  </CardHeader>
