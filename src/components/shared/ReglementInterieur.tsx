...
function Article({ number, title, content, icon: Icon, isImportant = false }: ArticleProps) {
  return (
    <Card className={`p-6 hover:shadow-lg transition-shadow ${isImportant ? 'border-l-4 border-l-[#1f3b8e] bg-blue-50' : ''}`}>
      <div className="flex items-start gap-4">
        <div className={`p-3 rounded-lg ${isImportant ? 'bg-[#1f3b8e] text-white' : 'bg-gray-100 text-gray-700'}`}>
  ...
  const articles = [
    {
      ...
      content: "Le présent Règlement Intérieur est actualisé en fonction de l'évolution de la législation, et notamment des dispositions du Décret 2019-1143 du 7 novembre 2019 (Article 4). Il obéit aux dispositions des articles L.6352-3 et 5 et R.6352-1 à 15 du Code du travail. Les sanctions pénales sont exposées en articles L.6355-8 et 9 du Code du travail.\n\nCe Règlement Intérieur est disponible et consultable par tout stagiaire ou apprenti avant son entrée en formation.",
      icon: FileText,
      isImportant: true
    },
    {
    ...
    },
    {
      ...
      content: "Pour les actions de formation organisées en sessions d'une durée totale supérieure à cinq cents heures, il est procédé simultanément à l'élection d'un délégué titulaire et d'un délégué suppléant au scrutin uninominal à deux tours. Tous les stagiaires ou apprentis sont électeurs et éligibles.\n\nLe scrutin se déroule pendant les heures de formation. Il a lieu au plus tôt vingt heures et au plus tard quarante heures après le début de la première session collective.",
      icon: Users
    },
    {
      number: "9",
      title: "Mandat et attributions des délégués des stagiaires",
      content: "Les délégués sont élus pour la durée de la formation. Leurs fonctions prennent fin lorsqu'ils cessent de participer à la formation.\n\nLes délégués font toute suggestion pour améliorer le déroulement des formations et les conditions de vie des stagiaires du Prestataire de formation. Ils présentent les réclamations individuelles ou collectives relatives à ces matières, aux conditions de santé et de sécurité au travail et à l'application du règlement Intérieur.",
      icon: Users
    },
    {
      number: "10",
      title: "Procédure de réclamation",
      content: "Les clients, stagiaires, apprentis, financeurs, équipe pédagogique « parties prenantes » à la prestation ont la possibilité à tout moment de faire une réclamation relative aux offres et prestations de formations du Prestataire de Formation par écrit en face-à-face, par courrier postal ou par mail en utilisant exclusivement le formulaire de réclamation disponible en téléchargement sur le site du Prestataire de Formation ou à demander à aurelien@gestionmax.fr et à retourner à la même adresse mail à l'attention du responsable du Prestataire de Formation.\n\nChaque réclamation sera étudiée et une réponse sera apportée à son expéditeur dans les meilleurs délais, idéalement par retour de mail au moyen du formulaire de réponse aux réclamations.",
      icon: Mail,
      isImportant: true
    }
  ];
      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto">
            Document officiel régissant les conditions de formation et les droits et obligations de tous les participants
          </p>
        </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mt-6 pt-6 border-t border-gray-300">
                <p className="text-sm text-gray-600">
                  Le présent Règlement Intérieur entre en vigueur le 20 juin 2023, et remplace toutes les versions précédentes.
                </p>
              </div>
            </div>
          </Card>
