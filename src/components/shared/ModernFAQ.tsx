...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Toutes nos formations se déroulent en présentiel à Nice, dans nos locaux équipés. Nous privilégions l\'interaction directe avec le formateur pour un apprentissage optimal. Chaque formation dure entre 14h et 28h selon le programme, réparties sur 2 à 4 jours consécutifs.',
    category: 'Modalités',
    icon: BookOpen,
  ...
  },
  {
    ...
    answer: 'Oui ! Toutes nos formations sont éligibles au CPF (Compte Personnel de Formation) et peuvent être financées par les OPCO. Nous sommes certifiés Qualiopi, garantissant la qualité de nos formations. Nous vous accompagnons dans les démarches administratives.',
  ...
  },
  {
    ...
    answer: 'Nos formations couvrent l\'écosystème WordPress complet : WordPress, WooCommerce, Elementor, Yoast SEO, SEOPress, Matomo, Brevo, Canva, Facebook Ads, LinkedIn Ads, ChatGPT, Make, et bien d\'autres. Chaque formation inclut des outils professionnels utilisés en entreprise.',
  ...
  },
  {
    ...
    answer: 'Absolument ! Chaque formation inclut 30 jours de support post-formation par email. Nous proposons également des sessions de suivi personnalisées pour vous accompagner dans la mise en pratique de vos nouvelles compétences. Un groupe d\'entraide est également disponible.',
    category: 'Suivi',
    icon: MessageCircle,
  ...
  },
  {
    ...
    answer: 'L\'entretien de positionnement (1h) est un moment privilégié pour évaluer vos besoins, objectifs et niveau actuel. Il se déroule en visioconférence ou en présentiel. Nous analysons vos projets, vos contraintes et définissons ensemble le parcours de formation le plus adapté à votre situation.',
  ...
  },
  {
    ...
    answer: 'Oui ! Nous adaptons nos formations aux besoins spécifiques de votre entreprise. Que ce soit pour former vos équipes internes ou pour des projets particuliers, nous créons des programmes sur mesure. Contactez-nous pour discuter de vos besoins spécifiques.',
    category: 'Entreprise',
    icon: Users,
  ...
  },
  {
    ...
    answer: 'Les inscriptions sont ouvertes toute l\'année. Nous recommandons de s\'inscrire au moins 2 semaines avant la date de formation. Le processus est simple : entretien de positionnement → devis personnalisé → inscription. Les places sont limitées à 8 personnes maximum par session.',
  ...
  },
  {
    ...
    answer: 'Nous garantissons votre satisfaction ! Si vous n\'êtes pas entièrement satisfait de votre formation, nous proposons une session de rattrapage gratuite ou un remboursement partiel. Notre taux de satisfaction de 95% témoigne de la qualité de nos formations.',
    category: 'Garantie',
    icon: Shield,
      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Trouvez rapidement les réponses à vos questions sur nos formations WordPress professionnelles
          </p>
        </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {featuredFAQs.map((faq) => {
                const Icon = faq.icon;
                return (
                  <Card key={faq.id} className="border-l-4 border-l-[#1f3b8e] hover:shadow-lg transition-shadow">
                    <button
        ...
        <div>
          <h3 className="text-2xl font-bold text-gray-900 mb-6">
            {selectedCategory === 'all' ? 'Toutes les questions' : `Questions - ${selectedCategory}`}
          </h3>
        ...
        <div className="mt-12 text-center">
          <div className="bg-gradient-to-r from-[#1f3b8e] to-[#7eb33f] rounded-2xl p-8 text-white">
            ...
            <p className="text-lg mb-6 opacity-90">
              Notre équipe est là pour vous accompagner. Contactez-nous pour une réponse personnalisée.
            </p>
