...
export function PublicRendezVousModal({ programmeId, programmeTitre, trigger }: PublicRendezVousModalProps) {
        ...
        <DialogHeader>
          ...
          <div className="bg-blue-50 p-4 rounded-lg mt-4">
            ...
            <p className="text-sm text-blue-600 mt-2">
              💡 Ce rendez-vous de positionnement est gratuit et sans engagement. 
              Il nous permettra d'analyser vos besoins et d'adapter la formation à votre profil.
            </p>
          </div>
        </DialogHeader>
          ...
          <div className="text-center py-12">
            ...
            <div className="mt-6 p-4 bg-green-50 rounded-lg">
              <p className="text-sm text-green-800">
                ...
                • Vérification de votre demande<br />
                • Confirmation par email ou téléphone<br />
                • Envoi des détails du rendez-vous
              </p>
            </div>
          </div>
        ) : (
