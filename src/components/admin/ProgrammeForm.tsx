...
export function ProgrammeForm({ programme, onSave, onCancel, isLoading = false }: ProgrammeFormProps) {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            {programme ? 'Modifier le programme' : 'Nouveau programme de formation'}
          </CardTitle>
        </CardHeader>
        <CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="Ex: Aucune, Certificat professionnel..."
                  />
                </div>
              </div>
            </div>
