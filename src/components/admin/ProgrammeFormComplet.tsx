...
export function ProgrammeFormComplet({ programme, onSave, onCancel, isLoading = false }: ProgrammeFormCompletProps) {
  const [formData, setFormData] = useState({
    ...
    formateurBiographie: 'Aurélien LAVAYSSIERE est un consultant formateur en informatique de gestion, spécialisé dans la formation des adultes. Doté d\'une solide expérience dans le domaine de la formation, Aurélien possède une expertise approfondie en matière de technologies web et de gestion d\'entreprise.'
  });
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={formData.modalites} onValueChange={(value) => handleInputChange('modalites', value)}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
