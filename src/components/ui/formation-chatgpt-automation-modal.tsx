...
export function FormationChatgptAutomationModal({ isOpen, onClose }: FormationChatgptAutomationModalProps) {
  ...
  const formationData = {
    ...
    modalites: {
      pedagogiques: 'Formation en présentiel individuel, avec une méthode expositive et démonstrative, alternant exposés théoriques et cas pratiques. Cette approche favorise une compréhension approfondie des concepts et une mise en application immédiate des compétences acquises.',
      ...
      evaluation: 'Quiz en ligne via EVALBOX (20 questions par bloc), travaux pratiques, grille d\'analyse des compétences, validation finale par projet. Ces modalités d\'évaluation permettent d\'assurer une validation progressive et complète des acquis théoriques et pratiques.',
