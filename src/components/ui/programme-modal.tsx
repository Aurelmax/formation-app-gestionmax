        ...
        {activeTab === 'overview' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-sm font-medium text-gray-500">Public concerné</CardTitle>
                </CardHeader>
                <CardContent>
            ...
            {programmeJour.map((jour, index) => (
              <Card key={index}>
                ...
                <CardContent className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-[#1f3b8e] mb-2">Matin (9h - 13h) : {jour.matin.titre}</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-[#1f3b8e] mb-2">Après-midi (14h - 17h) : {jour.apresMidi.titre}</h4>
                    <ul className="space-y-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-gray-600">Méthode expositive et démonstrative avec alternance théorie/pratique</p>
                </CardContent>
              </Card>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mb-3">
                    Conformément aux exigences réglementaires, vous pouvez télécharger le programme de formation complet au format PDF.
                  </p>
                  <Button
                    variant="outline"
                    size="sm"
