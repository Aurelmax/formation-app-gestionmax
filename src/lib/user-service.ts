  ...
  private loadUsersFromStorage() {
    try {
      ...
      if (storedUsers) {
        ...
        console.log('👥 Utilisateurs finaux après fusion:', this.users.map(u => u.email));
      } else {
        console.log('📁 Aucun utilisateur stocké dans localStorage - Utilisation des utilisateurs par défaut');
