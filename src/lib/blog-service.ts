import { Article, Categorie, Tag, CreateArticleRequest, UpdateArticleRequest, ArticleFilters, ArticleStats } from '@/types/blog';
...
const MOCK_ARTICLES: Article[] = [
  {
    ...
    contenu: '<h1>Introduction à WordPress</h1><p>WordPress est un système de gestion de contenu (CMS) qui permet de créer et gérer facilement des sites web...</p>',
    resume: 'Découvrez les bases de WordPress et comment créer votre premier site web professionnel.',
    ...
    imagePrincipale: 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=800&h=600&fit=crop',
  ...
  },
  {
    ...
    contenu: '<h1>Les bases du SEO</h1><p>Le référencement naturel est essentiel pour améliorer la visibilité de votre site...</p>',
    ...
    imagePrincipale: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=600&fit=crop',
  ...
  },
  {
    ...
    contenu: '<h1>Bibliothèque de médias</h1><p>WordPress offre une bibliothèque de médias complète pour gérer vos images...</p>',
...
const MOCK_TAGS: Tag[] = [
  { id: '1', nom: 'CMS', slug: 'cms', couleur: '#6B7280', createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
  { id: '2', nom: 'Débutant', slug: 'debutant', couleur: '#10B981', createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
  { id: '3', nom: 'Web', slug: 'web', couleur: '#3B82F6', createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
  { id: '4', nom: 'Référencement', slug: 'referencement', couleur: '#F59E0B', createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
  { id: '5', nom: 'Optimisation', slug: 'optimisation', couleur: '#EF4444', createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
  { id: '6', nom: 'Images', slug: 'images', couleur: '#8B5CF6', createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
  { id: '7', nom: 'Médias', slug: 'medias', couleur: '#06B6D4', createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
];
...
class BlogService {
  ...
  static async getArticles(filters?: ArticleFilters): Promise<Article[]> {
    ...
    if (filters) {
      ...
      if (filters.categorie) {
        articles = articles.filter(article => 
          article.categories.includes(filters.categorie!)
        );
      }
    ...
    return articles.sort((a, b) => new Date(b.datePublication).getTime() - new Date(a.datePublication).getTime());
  }
  ...
  static async createCategory(categoryData: Omit<Categorie, 'id' | 'createdAt' | 'updatedAt'>): Promise<Categorie> {
    await delay();
  ...
  static async getArticleStats(): Promise<ArticleStats> {
    ...
    const auteursActifs = Array.from(
      new Set(articles.map(a => a.auteur))
    ).map(auteur => ({
      auteur,
