...
export const required = (message = 'Ce champ est requis&apos;): ValidationRule<Record<string, unknown>> => 
  (value) => {
...
export const email = (message = 'Adresse email invalide'): ValidationRule<string> => 
  (value) => {
...
export const phone = (message = 'Numéro de téléphone invalide'): ValidationRule<string> => 
  (value) => {
    if (typeof value === 'string' && value) {
...
export const positive = (message = 'La valeur doit être positive'): ValidationRule<number> => 
  (value) => {
...
export const url = (message = 'URL invalide'): ValidationRule<string> => 
  (value) => {
    if (typeof value === 'string' && value) {
      try {
        new URL(value);
...
export const arrayMinLength = (min: number, message?: string): ValidationRule<unknown[]> => 
  (value) => {
...
export const arrayMaxLength = (max: number, message?: string): ValidationRule<unknown[]> => 
  (value) => {
...
export const formationCode = (message = 'Code formation invalide'): ValidationRule<string> => 
  (value) => {
    if (typeof value === 'string' && value) {
...
export const duration = (message = 'Durée invalide'): ValidationRule<string> => 
  (value) => {
    if (typeof value === 'string' && value) {
...
export const price = (message = 'Prix invalide'): ValidationRule<number> => 
  (value) => {
