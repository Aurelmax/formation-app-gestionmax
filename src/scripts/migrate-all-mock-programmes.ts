      ...
      try {
        ...
        const formationProgramme = {
          ...
          contact_formateur: {
            ...
            biographie: "Aurélien LAVAYSSIERE est un consultant formateur en informatique de gestion, spécialisé dans la formation des adultes. Doté d'une solide expérience dans le domaine de la formation, Aurélien possède une expertise approfondie en matière de technologies web et de gestion d'entreprise."
          },
          ...
          accessibilite_handicap: {
            ...
            adaptations_proposees: "Entretien téléphonique pour évaluer les besoins spécifiques au regard d'une situation de handicap, mise en œuvre des adaptations pédagogiques, organisationnelles et matérielles nécessaires."
          },
        ...
        console.error(`❌ Erreur lors de la migration du programme ${mockProgramme.codeFormation}:`, error.message);
      }
    }
