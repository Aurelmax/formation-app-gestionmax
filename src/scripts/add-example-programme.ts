...
async function addExampleProgramme() {
  ...
  try {
    ...
    const programmeExemple = {
      ...
      modalites_acces: {
        prerequis: "Maîtriser son environnement et les fonctions de base pour utiliser un ordinateur. Avoir des bases en marketing digital.",
        public_concerne: "Artisans, commerçants, professions libérales souhaitant développer leur présence digitale et leurs ventes en ligne.",
      ...
      contact_formateur: {
        ...
        biographie: "Aurélien LAVAYSSIERE est un consultant formateur en informatique de gestion, spécialisé dans la formation des adultes et plus particulièrement dans le domaine du marketing digital et des publicités en ligne. Doté d'une solide expérience dans le domaine de la formation, Aurélien possède une expertise approfondie en matière de publicités payantes, d'analyse de données et d'automatisation marketing."
      },
      ...
      sanction_formation: "Certificat de réalisation de formation. Une feuille d'émargement individuelle sera conjointement signée par le formateur et chaque stagiaire, pour chaque demi-journée de formation, permettant d'attester de l'exécution de l'action de formation.",
      ...
      accessibilite_handicap: {
        ...
        adaptations_proposees: "Entretien téléphonique, évaluation des besoins spécifiques au regard d'une situation de handicap, mise en œuvre des adaptations pédagogiques, organisationnelles et matérielles nécessaires."
      },

      cessation_abandon: {
        conditions_renonciation: "En cas de renonciation de l'apprenant(e) avant le début de la formation, aucune facturation",
        facturation_abandon: "En cas de renonciation en cours de formation, la facturation se fera au prorata de l'assiduité de l'apprenant(e)."
      }
    };
