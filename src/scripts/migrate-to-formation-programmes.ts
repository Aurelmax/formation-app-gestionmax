  ...
  try {
    ...
    const formationProgramme = {
          ...
          modules: [
            {
              ...
              description: 'Qu\'est-ce que WordPress ? Pourquoi choisir WordPress pour créer un site internet.',
              duree: '2h',
              contenu: {
                root: {
                  type: 'root',
      ...
      modalites_acces: {
        ...
        delais_mise_en_place: 'Dès réception de votre accord de prise en charge pour les professionnels.',
        tarif: 980,
      ...
      contact_formateur: {
        ...
        biographie: 'Aurélien LAVAYSSIERE est un consultant formateur en informatique de gestion, spécialisé dans la formation des adultes et plus particulièrement dans le domaine du CMS WordPress. Doté d\'une solide expérience dans le domaine de la formation, Aurélien possède une expertise approfondie en matière de gestion de sites web, avec une attention particulière portée à l\'utilisation efficace du CMS WordPress.'
      },
      ...
      ressources_dispo: [
        ...
        },
        {
          ...
          description: 'Projet et ressources téléchargeables sur Notion, un hébergement Web, quizz, fiches pratiques'
        }
      ],
      ...
      modalites_evaluation: {
        types_evaluation: [
          {
            type: 'Quizz',
            description: 'Quizz d\'une dizaine de questions par l\'intermédiaire de notre plateforme d\'évaluation en ligne EVALBOX'
          },
          {
      ...
      sanction_formation: 'Un certificat de réalisation de formation. Une feuille d\'émargement individuelle sera conjointement signée par le formateur et chaque stagiaire, pour chaque demi-journée de formation, permettant d\'attester de l\'exécution de l\'action de formation.',
      ...
      accessibilite_handicap: {
        ...
        adaptations_proposees: 'Un entretien téléphonique pour vous accompagner individuellement, évaluer vos besoins spécifiques au regard d\'une situation de handicap, mettre en œuvre les adaptations pédagogiques, organisationnelles et matériels nécessaires.'
      },

      cessation_abandon: {
        conditions_renonciation: 'En cas de renonciation de l\'apprenant(e) avant le début de la formation, aucune facturation',
        facturation_abandon: 'En cas de renonciation en cours de formation, la facturation se fera au pro rata de l\'assiduité de l\'apprenant(e).'
      }
    };
