...
export type ApprenantStatut = 'inscrit' | 'en_cours' | 'termine' | 'abandonne' | 'suspendu';
...
export type InscriptionStatut = 'en_attente' | 'confirmee' | 'en_cours' | 'terminee' | 'abandonnee';
...
export interface ApprenantNotification {
  id: string;
  apprenantId: string;
  type: 'nouveau_programme' | 'rendez_vous_planifie' | 'evaluation_disponible' | 'rapport_disponible';
  titre: string;
  message: string;
  dateEnvoi: Date;
